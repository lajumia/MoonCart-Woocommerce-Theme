...
<div class="page-content bg-white">
                ...
                <div class="col-xl-6 col-md-6 col-sm-5">
                  <div class="banner-media">
                    <div class="img-preview" data-swiper-parallax="-100">
                      <img src="<?php echo get_template_directory_uri( );?> /assets/images/slider/pic1.jpg" alt="banner-media">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="banner-content">
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-5">
                  <div class="banner-media">
                    <div class="img-preview" data-swiper-parallax="-100">
                      <img src="<?php echo get_template_directory_uri( );?> /assets/images/slider/pic2.jpg" alt="banner-media">
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="swiper swiper-product">
        <div class="swiper-wrapper product-style2">
          <div class="swiper-slide">
            <div class="product-box style-2 wow fadeInUp" data-wow-delay="0.1s" style="background-image: url('<?php echo get_template_directory_uri( );?> /assets/images/gym/1.png');">
          ...
          <div class="swiper-slide">
            <div class="product-box style-2 wow fadeInUp" data-wow-delay="0.2s" style="background-image: url('<?php echo get_template_directory_uri( );?> /assets/images/gym/2.png');">
              <div class="product-content">
                <div class="main-content">
          ...
          <div class="swiper-slide">
            <div class="product-box style-2 wow fadeInUp" data-wow-delay="0.3s" style="background-image: url('<?php echo get_template_directory_uri( );?> /assets/images/gym/3.png');">
              <div class="product-content">
                <div class="main-content">
          ...
          <div class="swiper-slide">
            <div class="product-box style-2 wow fadeInUp" data-wow-delay="0.4s" style="background-image: url('<?php echo get_template_directory_uri( );?> /assets/images/gym/4.png');">
              <div class="product-content">
                <div class="main-content">
    ...
    <div class="container">
      ...
      <div class="row gx-xl-4 g-3">
        <div class="col-xl-4 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.2s">
          <div class="category-product left">
            <a href="javascript:void(0);">								
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/category/pic1.jpg" alt="">
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="category-product left">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/category/pic2.jpg" alt="">
        ...
        <div class="col-xl-5 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.4s">
          <div class="category-product left">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/category/pic3.jpg" alt="">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="category-product right">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/category/pic4.jpg" alt="">
        ...
        <div class="col-xl-5 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.6s">
          <div class="category-product right">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/category/pic5.jpg" alt="">
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.7s">
          <div class="category-product right">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/category/pic6.jpg" alt="">
  ...
  <!-- icon-box1 -->
  <section class="content-inner-3 overlay-white-dark" style="background-image: url('<?php echo get_template_directory_uri( );?> /assets/images/background/bg2.jpg'); background-repeat: no-repeat; background-size: cover;">
    <div class="container">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="shop-card wow fadeInUp" data-wow-delay="0.2s">
                <div class="dz-media">
                  <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/9.png" alt="image">
                  <div class="shop-meta">
            ...
            <div class="swiper-slide">
              <div class="shop-card wow fadeInUp" data-wow-delay="0.3s">
                <div class="dz-media">
                  <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/10.png" alt="image">
                  <div class="shop-meta">
                    <a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                      <i class="fa-solid fa-eye d-md-none d-block"></i>
                      <span class="d-md-block d-none">Quick View</span>
            ...
            <div class="swiper-slide">
              <div class="shop-card wow fadeInUp" data-wow-delay="0.4s">
                <div class="dz-media">
                  <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/5.png" alt="image">
                  <div class="shop-meta">
                    <a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                      <i class="fa-solid fa-eye d-md-none d-block"></i>
                      <span class="d-md-block d-none">Quick View</span>
            ...
            <div class="swiper-slide">
              <div class="shop-card wow fadeInUp" data-wow-delay="0.5s">
                <div class="dz-media">
                  <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/11.png" alt="image">	
                  <div class="shop-meta">
                    <a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                      <i class="fa-solid fa-eye d-md-none d-block"></i>
                      <span class="d-md-block d-none">Quick View</span>
  ...
  <!-- Video Bx Start-->
  <section class="content-inner overlay-black-light" style="background-image: url('<?php echo get_template_directory_uri( );?> /assets/images/background/bg3.jpg'); background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row align-items-center dz-content-bx style-1">
        <div class="col-xl-7 col-lg-7 m-b30 wow fadeInLeft" data-wow-delay="0.1s">
          <div class="dz-media video-bx1 dz-img-overlay1">
            <img src="<?php echo get_template_directory_uri( );?> /assets/images/svg/video-img.png" alt="image">
          ...
          <div class="row">
            <div class="col-xl-12 col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="0.1s">
              <div class="offer-card text-center">
                <div class="dz-media">
                  <img src="<?php echo get_template_directory_uri( );?> /assets/images/offer/pic1.jpg" alt="">
                </div>
            ...
            <div class="col-xl-12 col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="0.2s">
              <div class="offer-card text-center">
                <div class="dz-media">
                  <img src="<?php echo get_template_directory_uri( );?> /assets/images/offer/pic2.jpg" alt="">
                </div>
                <div class="offer-content">
          ...
          <div class="clearfix">
            <ul id="masonry" class="row g-xl-4 g-3">
              <li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Begs">
                <div class="shop-card">
                  <div class="dz-media">
                    <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/12.png" alt="image">
                    <div class="shop-meta">
                      <a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        <i class="fa-solid fa-eye d-md-none d-block"></i>
                        <span class="d-md-block d-none">Quick View</span>
              ...
              <li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Bottle">
                <div class="shop-card">
                  <div class="dz-media">
                    <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/13.png" alt="image">
                    <div class="shop-meta">
                      <a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        <i class="fa-solid fa-eye d-md-none d-block"></i>
                        <span class="d-md-block d-none">Quick View</span>
              ...
              <li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Bottle">
                <div class="shop-card">
                  <div class="dz-media">
                    <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/14.png" alt="image">
                    <div class="shop-meta">
                      <a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        <i class="fa-solid fa-eye d-md-none d-block"></i>
                        <span class="d-md-block d-none">Quick View</span>
              ...
              <li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Begs">
                <div class="shop-card">
                  <div class="dz-media">
                    <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/15.png" alt="image">
                    <div class="shop-meta">
                      <a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        <i class="fa-solid fa-eye d-md-none d-block"></i>
                        <span class="d-md-block d-none">Quick View</span>
              ...
              <li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Toothbrushes">
                <div class="shop-card">
                  <div class="dz-media">
                    <img src="<?php echo get_template_directory_uri( );?> /assets/images/shop/16.png" alt="image">
                    <div class="shop-meta">
                      <a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        <i class="fa-solid fa-eye d-md-none d-block"></i>
                        <span class="d-md-block d-none">Quick View</span>
  ...
  <!-- Newsletter -->
  <section class="overlay-black-light newsletter-wrapper style-2" style="background-image: url('<?php echo get_template_directory_uri( );?> /assets/images/background/bg4.jpg'); background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      ...
      <div class="row gx-0">
        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.1s">
          <div class="insta-post dz-media dz-img-effect rotate">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/gym/feature/1.png" alt="">
            </a>
          </div>
        </div>
        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.2s">
          <div class="insta-post dz-media dz-img-effect rotate">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/gym/feature/2.png" alt="">
            </a>
          </div>
        </div>
        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.3s">
          <div class="insta-post dz-media dz-img-effect rotate">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/gym/feature/3.png" alt="">
            </a>
          </div>
        </div>
        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.4s">
          <div class="insta-post dz-media dz-img-effect rotate">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/gym/feature/4.png" alt="">
            </a>	
          </div>
        </div>
        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.5s">
          <div class="insta-post dz-media dz-img-effect rotate">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/gym/feature/5.png" alt="">
            </a>
          </div>
        </div>
        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.6s">
          <div class="insta-post dz-media dz-img-effect rotate">
            <a href="javascript:void(0);">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/gym/feature/6.png" alt="">
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="row gx-0">
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="icon-bx-wraper style-2 bg-light wow fadeInUp" data-wow-delay="0.1s">
            <div class="icon-bx">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/svg/password-check.svg" alt="">
            </div>
            <div class="icon-content">
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="icon-bx-wraper style-2 wow fadeInUp" data-wow-delay="0.2s">
            <div class="icon-bx">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/svg/cart.svg" alt="">
            </div>
            <div class="icon-content">
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="icon-bx-wraper style-2 bg-light wow fadeInUp" data-wow-delay="0.3s">
            <div class="icon-bx">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/svg/discovery.svg" alt="">
            </div>
            <div class="icon-content">
        ...
        <div class="col-xl-3 col-lg-3 col-sm-6">
          <div class="icon-bx-wraper style-2 wow fadeInUp" data-wow-delay="0.4s">
            <div class="icon-bx">
              <img src="<?php echo get_template_directory_uri( );?> /assets/images/svg/box-tick.svg" alt="">
            </div>
            <div class="icon-content">
